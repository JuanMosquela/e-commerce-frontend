...
const CardProduct = ({ product, row, grid, addedToFavs }) => {
  ...
  return (
    ...
    >
      ...
      <div className="px-4 py-2 flex-1  font-montserrat ">
        <h4 className="text-sm md:text-md lg:text-[16px] font-semibold  capitalize overflow-hidden whitespace-nowrap mb-2 ">
        ...
        <Rating
          ...
          readOnly
        />
        <h5 className=" text-xl text-dark font-bold ">$ {product?.price}</h5>
        {row && (
          <>
            <p className="text-slate font-thin font-nunito pt-2 mb-4">
